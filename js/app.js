var CONFIG = {"version":"0.2.5","hostname":"http://symlpigeon.github.io","root":"/","statics":"/","favicon":{"normal":"images/favicon.ico","hidden":"images/favicon.ico"},"darkmode":false,"auto_scroll":true,"js":{"valine":"gh/amehime/MiniValine@4.2.2-beta10/dist/MiniValine.min.js","chart":"npm/frappe-charts@1.5.0/dist/frappe-charts.min.iife.min.js","copy_tex":"npm/katex@0.12.0/dist/contrib/copy-tex.min.js","fancybox":"combine/npm/jquery@3.5.1/dist/jquery.min.js,npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js,npm/justifiedGallery@3.8.1/dist/js/jquery.justifiedGallery.min.js"},"css":{"valine":"css/comment.css","katex":"npm/katex@0.12.0/dist/katex.min.css","mermaid":"css/mermaid.css","fancybox":"combine/npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css,npm/justifiedGallery@3.8.1/dist/css/justifiedGallery.min.css"},"loader":{"start":false,"switch":false},"search":null,"valine":{"appId":"amyVU3zcpK0XzPeb5UbFtBXu-MdYXbMMI","appKey":"9LBOiquxlPTvprUxTuN1KqIl","placeholder":"都有啥要说的（","avatar":"mp","pageSize":10,"lang":"en","visitor":true,"NoRecordIP":true,"serverURLs":"https://amyvu3zc.api.lncldglobal.com","powerMode":true,"tagMeta":{"visitor":"guest","master":"author","friend":"friend","investor":"investor"},"tagColor":{"master":"var(--color-orange)","friend":"var(--color-aqua)","investor":"var(--color-pink)"},"tagMember":{"master":null,"friend":null,"investor":null}},"quicklink":{"timeout":3000,"priority":true}};const getRndInteger = function (min, max) {
...
const siteInit = function () {
  ...
  window.addEventListener('pjax:complete', refreshScript);

  siteRefresh(1)
}

const refreshScript = function () {
  // document
  ...
  if (window.mermaid) {
    ...
    mermaid.mermaidAPI.initialize({ startOnLoad: true, theme: 'forest', htmlLabels: true, securityLevel: "loose" });
    document.querySelectorAll(".mermaid").forEach(function (element) {
      if (element.hasAttribute("data-processed")) {
        return;
      }
      const graphDefinition = element.text || element.textContent || element.innerHTML || "";
      var id = "pic-" + Math.random().toString(16).slice(2)
      const cb = function (svg) {
        element.innerHTML = svg;
        element.setAttribute("data-processed", true);
      }
      mermaid.mermaidAPI.render(id, graphDefinition, cb);
    });
  }
}
